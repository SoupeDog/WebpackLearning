...
class Template extends React.Component {
    ...
    static getDerivedStateFromProps(props, state) {
        ...
        LogHelper.debug({className: "Template", tag: "props", msg: props, isJson: true});
        LogHelper.debug({className: "Template", tag: "state", msg: state, isJson: true});
        LogHelper.debug({msg: ""});
    ...
    static getDerivedStateFromError(error) {
        ...
        LogHelper.error({className: "Template", tag: "error", msg: error, isJson: true});
