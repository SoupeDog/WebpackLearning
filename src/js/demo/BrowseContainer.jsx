...
class BrowseContainer extends BaseComponent {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            leftMenu_Hide: false,
            markdown_Reader_Catalog_Position: "static",
                ...
                <JssProvider jss={jss} generateClassName={generateClassName}>
                    <MuiThemeProvider theme={this.state.callbackTheme}>
                        ...
                        <HW_Menu WindowsScrollHelper={this.state.WindowsScrollHelper}
                                 leftMenu_Hide={this.state.leftMenu_Hide}
                                 updateState={this.updateState.bind(this)}/>
                        <div id="top_backgroundImg"></div>
                        <div className={this.props.classes.root}>
                            <Grid container spacing={0} justify="center"
                            >
                                {this.state.leftMenu_Hide ? null : (
                                    <Grid container spacing={0} item xs={this.state.leftMenu_Hide ? null : 4}>
                                        <Grid container spacing={0} item xs={true}>
                                            <div id="markdown_Reader_Catalog" className="hyggeWriter_Markdown_Catalog"
                                                 style={{
                                                     position: this.state.markdown_Reader_Catalog_Position,
                                                     top: "61px",
                                                     height: (window.innerHeight - 60) + "px",
                                                     display: this.state.leftMenu_Hide ? "none" : ""
                                                 }}>
                                            </div>
                                        </Grid>
                                    </Grid>
                                ...
                                <Grid item xs={this.state.leftMenu_Hide ? 10 : 7}>
                                    <div id="markdown_Reader_TestView" className="hyggeWriter_Markdown_Reader"
                                         style={{minHeight: window.innerHeight}}></div>
                                </Grid>
                                {this.state.leftMenu_Hide ? null : (
                                    <Grid item xs={this.state.leftMenu_Hide ? false : 1}>
                                    </Grid>
                                )
                                }
                            </Grid>
    ...
    componentDidMount() {
        ...
        localStorage.setItem("md1", text);
        localStorage.setItem("md2", text2);

        MarkdownHelper.formatToHtml({
            text: localStorage.getItem("md1"),
    ...
    checkCatalogPosition(currentY) {
        if (currentY > 230) {
            this.setState({markdown_Reader_Catalog_Position: "fixed"});
        } else {
            this.setState({markdown_Reader_Catalog_Position: "static"});
        }
    }
